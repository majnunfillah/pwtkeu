...
SELECT A.NOBUKTI, A.TANGGAL, B.DEVISI, A.NOTE, A.LAMPIRAN, 
       ...
       B.KETERANGAN, B.KETERANGAN2, B.DEBET, B.KREDIT, B.VALAS, 
       B.KURS, B.DEBETRP, B.KREDITRP, B.STATUSGIRO, B.MYID, 
       'KASBANK' AS JENIS, A.NOURUT
FROM DBO.DBTRANS A 
...
GO
ALTER DATABASE [dbwbcp] ADD FILEGROUP [TempFG]
GO
...
This project contains the database schema and scripts for the `dbwbcp` database. It includes tables, views, users, and roles necessary for the application. Each SQL script is organized into directories for better management.