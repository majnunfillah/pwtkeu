...
This project contains SQL scripts for creating and managing the database schema, including tables, views, users, and roles. Each script is organized into directories for better structure and maintainability.