...
This project contains the schema for the `dbwbcp` database, including tables, views, users, and roles. Each SQL file defines the structure and constraints for the respective database objects.