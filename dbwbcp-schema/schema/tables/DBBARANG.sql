...
This project contains the database schema for the application. It includes tables, views, users, and roles necessary for the application's functionality. Each SQL file defines a specific part of the schema, including constraints and relationships.